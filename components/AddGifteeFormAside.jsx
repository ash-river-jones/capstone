...
export default function AddGifteeFormAside() {
	return (
		<div className='overflow-hidden bg-white shadow h-full rounded-xl'>
			<div className='px-4 py-5 '>
				<h3 className='text-base font-semibold leading-6 text-gray-900'>Applicant Information</h3>
				<p className='mt-1 max-w-2xl text-sm text-gray-500'>Personal details and application.</p>
			</div>
			<div className='border-t border-gray-200 px-4 py-5 h-max'>
